									...
									<table id="data-table-fixed-header" class="table table-bordered table-responsive dt-responsive nowrap table-striped align-middle dataTable no-footer dtr-inline collapsed" style="width: 100%;" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="1%">Nomor PKPT</th>
                                                <th width="1%">Jenis PKPT</th>
                                                <th width="1%">PKP</th>
                                                <th width="1%">Nota Dinas</th>
                                                <th width="1%">Status</th>
                                                @if (Auth::user()['role_id']==2)
                                                    <th width="1%" >Action</th>
                                                @else
                                                    <th width="1%" >Status Keterangan</th>
                                                    <th width="1%" >Pesan</th>
                                                @endif
                                            </tr>
                                        </thead>
...
<script>
    ...
    function tambah(){
        location.assign("{{url('perencanaan/program-kerja-pengawasan/create')}}");
    }
