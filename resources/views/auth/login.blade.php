                                        ...
                                        <div class="position-relative h-100 d-flex flex-column">
                                            <div class="mb-4">
                                                <a href="index.html" class="d-block">
                                                    <img style="object-fit: cover" src="{{url_plug()}}/img/logo5.png" alt="" width="80%">
                                                </a>
                                            </div>
                                            <div class="mt-auto">
                                                <div class="mb-3">
                                                ...
                                                <div id="qoutescarouselIndicators" class="carousel slide" data-bs-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner text-center text-white-50 pb-5">
                                                        ...
                                                        <div class="carousel-item">
                                                            <p class="fs-15 fst-italic">" Aplikasi Audit Management System (AMS) Inspektorat Cilegon."</p>
                                                        </div>
                                                        <div class="carousel-item">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Ams. Audit Management System <i class="mdi mdi-heart text-danger"></i> by Inspektorat Kota Cilegon
                            </p>
                        </div>
                    </div>
                </div>
