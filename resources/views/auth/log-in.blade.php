...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" style="border-radius: 50%;" href="{{url_plug()}}/img/kemenlu.png">
...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{url_plug()}}/img/logo.png" alt="" width="100%">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Audit Management System</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Kemenlu.</p>
                                </div>
                                <div class="p-2 mt-4">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> Dinas Inspektorat Cilegon
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- particles js -->
    <script src="{{url_plug()}}/assets/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script src="{{url_plug()}}/assets/js/pages/particles.app.js"></script>
    <!-- password-addon init -->
