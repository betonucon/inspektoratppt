                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="area_pengawasan" class="form-control" required value="{{$data->area_pengawasan}}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control"  name="jenis_pengawasan"  id="jenis_pengawasan">
                                                ...
                                                @foreach ($jenisPengawasan as $jp)
                                                    <option value="{{ $jp->jenis }}" {{ $jp->jenis == $data->jenis_pengawasan ? 'selected' : '' }}> {{ $jp->jenis }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control"  name="opd"  id="opd">
                                                <option value=""> --Pilih-- </option>
                                                @foreach ($opd as $o)
                                                    <option value="{{ $o->nama }}" {{ $o->nama == $data->opd ? 'selected' : '' }}> {{ $o->nama }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control"  name="rmp"  id="rmp">
                                                <option value=""> --Pilih-- </option>
                                                @foreach ($rmp as $r)
                                                    <option value="{{ $r->bulan }}" {{ $r->bulan == $data->rmp ? 'selected' : '' }}> {{ $r->bulan }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control"  name="rpl"  id="rpl">
                                                <option value=""> --Pilih-- </option>
                                                @foreach ($rmp as $r)
                                                    <option value="{{ $r->bulan }}" {{ $r->bulan == $data->rpl ? 'selected' : '' }}> {{ $r->bulan }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="sarana_prasarana" id="sarana_prasarana" class="form-control" required value="{{$data->sarana_prasarana}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control"  name="tingkat_resiko"  id="tingkat_resiko">
                                                <option value=""> --Pilih-- </option>
                                                @foreach ($tingkatResiko as $tr)
                                                    <option value="{{ $tr->name }}" {{ $tr->name == $data->tingkat_resiko ? 'selected' : '' }}> {{ $tr->name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="tujuan" id="tujuan" cols="5" rows="5" required>{{$data->tujuan}}</textarea>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="koorwas" id="koorwas" class="form-control" required value="{{$data->koorwas}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="pt" id="pt" class="form-control" required value="{{$data->pt}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="kt" id="kt" class="form-control" required value="{{$data->kt}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="at" id="at" class="form-control" required value="{{$data->at}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="jumlah_laporan" id="jumlah_laporan" class="form-control" required value="{{$data->jumlah_laporan}}">
                                        </div>
                                    </div>
